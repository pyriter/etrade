...
describe("CredentialsProvider", () => {
  ...
  xit("should update the credentials", async () => {
    ...
    expect(actualCredentials.access_token).toEqual(
      expectedCredential.access_token
    );
    expect(actualCredentials.refresh_token).toEqual(
      expectedCredential.refresh_token
    );
    expect(actualCredentials.refresh_token_expires_in).toEqual(
      expectedCredential.refresh_token_expires_in
    );
    expect(actualCredentials.access_token_modified_date).toEqual(
      expectedCredential.access_token_modified_date
    );
  });
});
